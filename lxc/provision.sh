...
#
# Usage:
#   bash <(curl -fsSL https://raw.githubusercontent.com/scottdkey/homeassistant/main/lxc/provision.sh) <vmid> [options]
#
# Options:
...
REPO_RAW="https://raw.githubusercontent.com/scottdkey/homeassistant/${BRANCH}"
